...
public class LikesApiController {
    ...
    public ResponseEntity<String> pushLikes(@PathVariable("memberId") Long memberId, @PathVariable("itemId") Long itemId, @AuthenticationPrincipal PrincipalDetails principalDetails){
        if (memberId == principalDetails.getMember().getId()) {
